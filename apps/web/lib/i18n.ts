...
export const dict = {
  ar: {
    ...
    announce: "نرحّب بقطّطكم في جدة والرياض — انضمّ للمجتمع",
    hero: {
      badge: "عضوية خاصة لأهل القطط",
      title: "قطك يستاهل",
      titleAccent: "هوية تخصّه وحده",
      subtitle:
        "مرقط عضوية لكل واحد ياخذ قطه على محمل الجد. هوية رسمية لقطك، وملف صحي يمشي معاه وين ما راح، ومجتمع من أهل القطط في جدة والرياض.",
    ...
    features: {
      ...
      items: [
        ...
        { eyebrow: "الجاي أحلى", title: "نكبر معك", body: "أسعار الأعضاء والتوصيل الشهري جايين قريب. الحين الهوية والملف الصحي والمجتمع لك — ببلاش." },
      ],
    },
    plans: {
      title: "اختر عضوية قطك",
      subtitle: "العضويات جايه قريب. أول ما تنزل: سعر واحد واضح، ألغِ متى ما تبي وبدون رسوم خفية — التوفير ميزة، مو هدفنا.",
      month: "/ شهرياً",
  ...
  en: {
    ...
    announce: "Now welcoming cats in Jeddah & Riyadh — join the community",
    hero: {
      badge: "The membership for cat people",
      title: "Give your cat",
      titleAccent: "an identity of their own",
      subtitle:
        "Moracat is a membership for people who take their cats seriously. An official Cat ID, a health record that follows them anywhere, and a community of cat people across Jeddah & Riyadh.",
    ...
    features: {
      ...
      items: [
        ...
        { eyebrow: "What's next", title: "Built to grow with you", body: "Member rates and monthly essentials are on the way. For now, the Cat ID, health record and community are yours — free." },
      ],
    },
    plans: {
      title: "Choose your cat's membership",
      subtitle: "Memberships are coming soon. When they arrive: one clear price, cancel anytime, no hidden fees — the savings a perk, never the pitch.",
      month: "/ month",
      popular: "Most chosen",
